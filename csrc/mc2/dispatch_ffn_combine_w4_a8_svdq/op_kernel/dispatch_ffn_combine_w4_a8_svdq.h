...
public:
    ...
    {
        if (!ResidualGmmOfficialTilingBridgeReady(stageId)) {
            return false;
        }
        SVDQOfficialW4A8FullLifecycleLaunch launch = BuildOfficialW4A8FullLifecycleLaunch();
