...
#include "svdq_lowrank_debug_readback.h"

using namespace AscendC;
using namespace DispatchFFNCombineW4A8SVDQImpl;

extern "C" __global__ __aicore__ void svdq_lowrank_debug_readback(
    ...
    GM_ADDR gateUpAccumulator, GM_ADDR downAccumulator, GM_ADDR tilingGM)
{
