...
#ifndef OP_API_INC_SVDQ_W4A8_DEBUG_READBACK_
#define OP_API_INC_SVDQ_W4A8_DEBUG_READBACK_
...
__attribute__((visibility("default"))) aclnnStatus aclnnSVDQW4A8DebugReadbackGetWorkspaceSize(
...
#endif  // OP_API_INC_SVDQ_W4A8_DEBUG_READBACK_
