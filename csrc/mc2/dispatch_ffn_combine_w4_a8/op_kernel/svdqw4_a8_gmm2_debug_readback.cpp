...
extern "C" __global__ __aicore__ void svdqw4_a8_gmm2_debug_readback(
    ...
    GM_ADDR gmm2PostDequant, GM_ADDR hiddenXReadback, GM_ADDR hiddenScaleReadback,
    GM_ADDR gmm2AccumulatorInt32, GM_ADDR workspaceGM, GM_ADDR tilingGM)
{
    ...
    if (TILING_KEY_IS(1000010)) {
        ...
        op.InitFullLifecycleWithExternalGMM2Hidden(x, w1, w2, expertId, scale1, scale2, bias1, bias2, probs,
            xActiveMask, c, expertTokenNums, workspaceGM, tilingGM, hiddenXInt4Packed, hiddenXScale,
            externalExpertTokenNums, gmm2PostDequant, hiddenXReadback, hiddenScaleReadback, gmm2AccumulatorInt32);
        op.Process();
    }
}
